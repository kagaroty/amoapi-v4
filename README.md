...
- ✅ Мультиаккаунтность
- ✅ Запросы от имени пользователя (`X-Context-User-ID`)
...
| Раздел | Описание |
|--------|----------|
| [Конфигурация](docs/configuration.md) | Клиент, OAuth, кеш, callbacks, мультиаккаунт, произвольные запросы, запросы от имени пользователя |
